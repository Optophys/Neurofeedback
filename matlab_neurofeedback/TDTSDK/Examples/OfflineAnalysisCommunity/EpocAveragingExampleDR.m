...
%
% <html>
% Contributing Author: David H. Root <br>
...
% This example goes through fiber photometry analysis using <b>similar</b>
% methods to <a href="https://doi.org/10.1016/j.celrep.2017.10.066">Barker et al.,
% 2017 (DOI)</a>. <br>
% This includes bleach detrending and z-score analysis. <br>
% The epoch averaging was done using TDTfilter. <br><br>
% About the author: <br>
% The Root lab investigates the neurobiology of reward, aversion, addiction, and depression. <br>
% <br> TDT edits all user submissions in coordination with the contributing
% author prior to publishing.
% </html>
